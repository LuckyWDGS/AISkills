...
These prompt recipes are for CodexManager image generation and edit/reference-image workflows in this skill.
...
Execution details such as explicit CLI flags, `quality`, masks, output formats, and local output paths belong in the CLI/API call, not in the visual prompt text.
