...
- 尽量优先 `2` 的幂次方尺寸：`256 / 512 / 1024 / 2048`
- 单张小粒子：`256 - 512`
...
- 运行时纹理尽量不要随手给 `1000x1000`、`1500x900` 这类尺寸
- Flipbook / Atlas 最好让整张画布和单格尺寸都尽量接近 `2` 的幂次方
- 常见安全值：
  - `4x4` atlas 搭配 `1024x1024`，每格 `256x256`
  - `8x8` atlas 搭配 `2048x2048`，每格 `256x256`
  - `8x8` atlas 搭配 `1024x1024`，每格 `128x128`
