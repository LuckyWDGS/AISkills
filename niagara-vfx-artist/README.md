...
### `references/feasibility-and-fidelity-guide.md`
...
什么时候改它：
- 你想让这套 skill 更稳定地产出纹理生成输入
- 你想把纹理生成流程标准化
- 你想减少“prompt 写得很多但类型判断错了”的问题

这个文件更偏“纹理生成输入模板库”。

### `references/model-turnaround-and-asset-gen-guide.md`
...
- 什么不该优先做模型
- 多视图标准
- Front / Side / Back / Top / 3/4 的统一规则
- 正交 / 透视要求
- 背景、光照、比例、尺度要求
- 多视图 prompt 模板

什么时候改它：
- 你想让这套 skill 能更好地服务模型资产生成
- 你想统一多视图输入标准
- 你想减少“好看但不可重建”的参考图

这个文件更偏“模型生成输入规范”。

### `references/idea-to-prompt-fastloop.md`
...
什么时候改它：
- 你想让这套 skill 更擅长处理模糊需求
- 你想在实现前先快速验证方向
- 你想把“先出图 / 先出视频再确认”变成标准流程
